...
const api: Api = {
  ...
  'inventory:recordMovement': (payload) => ipcRenderer.invoke('inventory:recordMovement', payload),
  'inventory:stockBalance': (itemId) => ipcRenderer.invoke('inventory:stockBalance', itemId),
  'inventory:stockMovements': (itemId, limit) => ipcRenderer.invoke('inventory:stockMovements', itemId, limit),
  'inventory:stockAvailability': (itemIds) => ipcRenderer.invoke('inventory:stockAvailability', itemIds),
  ...
  'system:kitchenStatus': () => ipcRenderer.invoke('system:kitchenStatus'),
  'system:restartKds': (port) => ipcRenderer.invoke('system:restartKds', port),
  'system:kitchenUrls': () => ipcRenderer.invoke('system:kitchenUrls'),
  ...
  'recipes:list': () => ipcRenderer.invoke('recipes:list'),
  'recipes:get': (id) => ipcRenderer.invoke('recipes:get', id),
  'recipes:create': (payload) => ipcRenderer.invoke('recipes:create', payload),
  'recipes:update': (id, payload) => ipcRenderer.invoke('recipes:update', id, payload),
  'recipes:delete': (id) => ipcRenderer.invoke('recipes:delete', id),
