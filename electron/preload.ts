...
const api: Api = {
  ...
  'reports:proteinPerformance': (start, end) => ipcRenderer.invoke('reports:proteinPerformance', start, end),
  ...
  'proteins:listAll': () => ipcRenderer.invoke('proteins:listAll'),
  ...
  'starches:listAll': () => ipcRenderer.invoke('starches:listAll'),
  'starches:upsert': (payload) => ipcRenderer.invoke('starches:upsert', payload),
  'starches:delete': (id) => ipcRenderer.invoke('starches:delete', id),
